...
const Login = () => {
  ...
  return (
    ...
    //   </div>
    // </section>
    // fake login page with form, email and password inputs, submit button, ONLY THIS NO THINGS
    <div className="min-h-screen flex items-center justify-center bg-light text-dark font-sans">
      <form onSubmit={submit} className="glass-surface rounded-3xl border border-dark/10 p-8 max-w-md w-full space-y-6 shadow-sm">
        ...
        <div className="space-y-4">
          ...
          <div>
            <label htmlFor="password" className="block text-sm font-medium text-foreground/70 mb-1">Password</label>
            <input
              id="password"
              type="password"
              autoComplete="off"
